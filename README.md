...
> * To develop and run functions on your local machine, we can actually install the full Azure Functions runtime on your device. It's named **Azure Functions Core Tools** and you can learn all about it [here](https://docs.microsoft.com/en-us/azure/azure-functions/functions-run-local?tabs=v3%2Cwindows%2Ccsharp%2Cportal%2Cbash%2Ckeda). On this page, you'll also find a download/install instructions for various operating systems. If you're on Windows, you can also simply use [this direct download link](https://go.microsoft.com/fwlink/?linkid=2174087).
